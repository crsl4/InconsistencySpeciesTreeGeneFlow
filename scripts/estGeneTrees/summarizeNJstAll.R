# to run in njst, snaq, phylonet,
# make sure to change path and file names at the end
...
for(g in gamma){
  ...
  save(alltable,file=paste(g,"_alltablenjst.Rda",sep=""))
  write.table(alltable,file=paste(g,"_alltablenjst.txt",sep=""),sep=",",row.names=FALSE)
